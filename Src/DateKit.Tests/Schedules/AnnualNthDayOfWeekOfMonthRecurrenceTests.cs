...
public class AnnualNthDayOfWeekOfMonthRecurrenceTests
{
	...
	public void Create_WithArgumentOutOfRange_ThrowsException(
		Int32 month, DayOfWeek dayOfWeek, Int32 instance, String expectedParamName)
	{
		// Act:
		Func<AnnualNthDayOfWeekOfMonthRecurrence> func = () =>
			AnnualNthDayOfWeekOfMonthRecurrence.Create(month, dayOfWeek, instance);
	...
	public void Create_WithNullOptions_ThrowsException()
	{
		...
		// Act:
		Func<AnnualNthDayOfWeekOfMonthRecurrence> func = () =>
			AnnualNthDayOfWeekOfMonthRecurrence.Create(month: 6, Thursday, instance: 3, options);
	...
	public void Create_WithValidArgumentsAndDefaultOptions_ReturnsInstance(
		Int32 month, DayOfWeek dayOfWeek, Int32 instance)
	{
		// Act:
		AnnualNthDayOfWeekOfMonthRecurrence recurrence =
			AnnualNthDayOfWeekOfMonthRecurrence.Create(month, dayOfWeek, instance);
		...
		Int32 month, DayOfWeek dayOfWeek, Int32 instance, Date date, Boolean expectedResult)
	{
		...
		Schedule schedule = AnnualNthDayOfWeekOfMonthRecurrence.Create(month, dayOfWeek, instance, options);
	...
	public void EnumerateBackwardFrom_WithValidDate_ReturnsExpected(Date date, Date[] expectedResults)
	{
		// Arrange:
		AnnualNthDayOfWeekOfMonthRecurrenceOptions options = new() { StartYear = 2000, EndYear = 2002 };
		Schedule schedule = AnnualNthDayOfWeekOfMonthRecurrence.Create(month: 6, Thursday, instance: 3, options);
		...
		DayOfWeek dayOfWeek, Int32 instance, Int32 year, Int32 month, Int32 expectedDay)
	{
		// Arrange:
		AnnualNthDayOfWeekOfMonthRecurrenceOptions options = new() { StartYear = 2000, EndYear = 2002 };
		AnnualRecurrence recurrence = AnnualNthDayOfWeekOfMonthRecurrence.Create(month, dayOfWeek, instance, options);

		// Act:
		Date actualResult = recurrence.GetOccurrence(year);

		// Assert:
		actualResult.Should().Be(new Date(year, month, expectedDay));
	}
