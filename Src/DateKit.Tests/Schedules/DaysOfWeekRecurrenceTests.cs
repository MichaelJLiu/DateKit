...
public class DaysOfWeekRecurrenceTests
{
	...
	public void Constructor_WithArgumentOutOfRange_ThrowsException(DaysOfWeek daysOfWeek, String expectedMessage)
	{
		// Act:
		Func<DaysOfWeekRecurrence> func = () => new DaysOfWeekRecurrence(daysOfWeek);
	...
	public void Constructor_WithNullOptions_ThrowsException()
	{
		...
		// Act:
		Func<DaysOfWeekRecurrence> func = () => new DaysOfWeekRecurrence(Sunday | Saturday, options);
	...
	public void Contains_WithValidDate_ReturnsExpected(DaysOfWeek daysOfWeek, Date date, Boolean expectedResult)
	{
		...
		Schedule schedule = new DaysOfWeekRecurrence(daysOfWeek, options);
