...
public class AnnualDayOfWeekOfMonthRecurrenceTests
{
	...
	[TestCase(3, DayOfWeek.Monday, -5, "instance")]
	[TestCase(6, DayOfWeek.Wednesday, 0, "instance")]
	[TestCase(9, DayOfWeek.Thursday, 5, "instance")]
		...
		Int32 month, DayOfWeek dayOfWeek, Int32 instance, String expectedParamName)
	{
		...
		Func<AnnualDayOfWeekOfMonthRecurrence> func = () =>
			new AnnualDayOfWeekOfMonthRecurrence(month, dayOfWeek, instance);
	...
	{
		// Act:
		AnnualDayOfWeekOfMonthRecurrence recurrence = new(month, dayOfWeek, instance);
	...
	{
		// Arrange:
		Schedule schedule = new AnnualDayOfWeekOfMonthRecurrence(month: 6, DayOfWeek.Thursday, instance: 3);
		...
		Int32 month, DayOfWeek dayOfWeek, Int32 instance, Date date, Boolean expectedResult)
	{
		...
		Schedule schedule = new AnnualDayOfWeekOfMonthRecurrence(month, dayOfWeek, instance, options);
	...
	private static IEnumerable<Object[]> GetContainsTestCases()
	{
		...
		{
			return [month, DayOfWeek.Thursday, instance, date, expectedResult];
		}
		...
		[
			...
			CreateTestCase(6, 3, new Date(2000, 6, 15), true), // right instance; maxDay - date.Day == 6
			CreateTestCase(6, 3, new Date(2000, 6, 22), false), // wrong instance; maxDay - date.Day == -1
			CreateTestCase(6, 3, new Date(2001, 6, 14), false), // wrong instance; maxDay - date.Day == 7
			CreateTestCase(6, 3, new Date(2001, 6, 21), true), // right instance; maxDay - date.Day == 0
			CreateTestCase(10, -3, new Date(2001, 10, 11), true), // right instance; maxDay - date.Day == 6
			CreateTestCase(10, -3, new Date(2001, 10, 18), false), // wrong instance; maxDay - date.Day == -1
			CreateTestCase(10, -3, new Date(2002, 10, 10), false), // wrong instance; maxDay - date.Day == 7
			CreateTestCase(10, -3, new Date(2002, 10, 17), true), // right instance; maxDay - date.Day == 0
	...
	public void EnumerateBackwardFrom_WithValidDate_ReturnsExpected(Date date, Date[] expectedResults)
	{
		// Arrange:
		AnnualDayOfWeekOfMonthRecurrenceOptions options = new() { StartYear = 2000, EndYear = 2002 };
		Schedule schedule = new AnnualDayOfWeekOfMonthRecurrence(month: 6, DayOfWeek.Thursday, instance: 3, options);
	...
	public void GetOccurrence_WithUnscheduledYear_ReturnsEmptyDate(Int32 year)
	{
		...
		AnnualRecurrence recurrence =
			new AnnualDayOfWeekOfMonthRecurrence(month: 6, DayOfWeek.Thursday, instance: 3, options);
		...
		DayOfWeek dayOfWeek, Int32 instance, Int32 year, Int32 month, Int32 expectedDay)
	{
		...
		AnnualRecurrence recurrence =
			new AnnualDayOfWeekOfMonthRecurrence(month, dayOfWeek, instance, options);
