...
{
	/// <summary>
	/// Creates an <see cref="InverseSchedule" /> using a specified base schedule.
	/// </summary>
	/// <param name="baseSchedule">
	/// The <see cref="Schedule" /> to invert.
	/// </param>
	/// <returns>
	/// An <see cref="InverseSchedule" /> that inverts <paramref name="baseSchedule" />.
	/// </returns>
	/// <exception cref="ArgumentNullException">
	/// <paramref name="baseSchedule" /> is <see langword="null" />.
	/// </exception>
	public static InverseSchedule Create(Schedule baseSchedule)
	{
		return new InverseSchedule(baseSchedule);
	}
	...
	/// <paramref name="baseSchedule" /> is <see langword="null" />.
	/// </exception>
	private InverseSchedule(Schedule baseSchedule)
	{
